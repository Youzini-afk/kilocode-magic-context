...
It uses the real OpenCode HTTP API via `@kilocode/sdk`, creates real sessions, replays dataset user turns, asks the benchmark question in a new session, and judges the answer with the official LongMemEval prompt logic.
