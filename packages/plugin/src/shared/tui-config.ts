 ...
 * any form. Covers:
 *   - Bare npm name: "kilocode-magic-context"
 *   - Versioned npm: "kilocode-magic-context@latest" / "@0.15.7" / etc.
 ...
 *   - Tarball paths ending in kilocode-magic-context-*.tgz
 *
...
function isMagicContextEntry(entry: string): boolean {
    ...
    if (entry.includes("kilocode-magic-context")) return true;
    return false;
}
