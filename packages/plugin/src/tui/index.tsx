...
import type { TuiPlugin, TuiPluginApi, TuiThemeCurrent } from "@kilocode/plugin/tui"
...
const PLUGIN_NAME = "kilocode-magic-context"
                ...
                setTimeout(() => {
                    api.ui.dialog.replace(() => (
                        <api.ui.DialogAlert
                            ...
                            message={`${actionSummary}\n\nPlease restart Kilo for changes to take effect.`}
                            onConfirm={() => {
                                api.ui.toast({ message: "Restart Kilo to enable Magic Context", variant: "warning", duration: 10000 })
                            }}
                        />
                    ))
                }, 50)
    ...
    api.ui.dialog.replace(() => (
        <api.ui.DialogConfirm
            ...
            message={[
                ...
                "(Kilo's TUI plugin configuration file).",
                "",
                "Add it now?",
            ].join("\n")}
            onConfirm={() => {
                ...
                setTimeout(() => {
                    api.ui.dialog.replace(() => (
                        <api.ui.DialogAlert
                            ...
                            message="tui.json updated with Magic Context plugin.\n\nPlease restart Kilo to see the sidebar."
                            onConfirm={() => {
                                api.ui.toast({ message: "Restart Kilo to see the sidebar", variant: "warning", duration: 10000 })
                            }}
                        />
                    ))
                }, 50)
            ...
            onCancel={() => {
                api.ui.toast({ message: "You can add the sidebar later via: bunx --bun kilocode-magic-context@latest doctor --fix", variant: "info", duration: 5000 })
            }}
        />
    ))
}
...
const id = "kilocode-magic-context"
