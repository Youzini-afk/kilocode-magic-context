...
type ModelContextLimitConfig = { default?: number; [modelKey: string]: number | undefined };

let modelContextLimitOverrides: ModelContextLimitConfig | undefined;

export function setModelContextLimitOverrides(config: ModelContextLimitConfig | undefined): void {
    modelContextLimitOverrides = config;
}
...
export function resolveContextLimit(
    ...
    const override = resolveModelContextLimitOverride(modelContextLimitOverrides, modelKey);
...
function resolveModelContextLimitOverride(
    config: ModelContextLimitConfig | undefined,
    ...
    return typeof config.default === "number" ? config.default : undefined;
}
